...
RUN apt-get install -y runit naemon-core naemon-tools naemon-livestatus thruk nagios-plugins ssmtp nginx nagios-nrpe-plugin libfcgi-procmanager-perl libapache2-mod-fcgid
